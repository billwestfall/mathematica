...
MakeDeck[] :=  Tuples[{{"Land ", "Creature ", "Artifact " , "Enchantment " , "Unhinged Creature ", "Instant " , "Sorcery " , "Unhinged Sorcery " , "Full art ", "Multi land ", "Multi creature "}, {"Black", "Red", "White", "Blue", "Green"}}]
