...
exprog[] := (q = DeleteCases[o, p]; r = RandomChoice[q]; Print["Next card is: ", r])
exproh[] := (q = DeleteCases[o, p]; r = RandomChoice[q]; Print["Next card is: ", r])
exproi[] := (q = DeleteCases[o, p]; r = RandomChoice[q]; Print["Next card is: ", r])
exproj[] := (q = DeleteCases[o, p]; r = RandomChoice[q]; Print["Next card is: ", r])
exprok[] := (q = DeleteCases[o, p]; r = RandomChoice[q]; Print["Next card is: ", r])
