...
exprom[] := (kk = DeleteCases[ii, jj]; ll = RandomChoice[kk]; Print["My twenty first card is: ", ll])
expron[] := (mm = DeleteCases[kk, ll]; nn = RandomChoice[mm]; Print["My twenty second card is: ", nn])
